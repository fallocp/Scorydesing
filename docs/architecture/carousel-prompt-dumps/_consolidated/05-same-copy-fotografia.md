# Mismo copy · Fotografía

Esta es una vista consolidada para consulta. Los archivos fuente individuales siguen siendo la evidencia canónica.

Leyenda de procedencia:
- **REAL**: artefacto capturado de una ejecución o respuesta real.
- **RECONSTRUIDO**: artefacto reconstruido exactamente desde builders, fixtures o requests controlados cuando no se conservó la captura raw.
- **NO CAPTURADO**: artefacto que el runtime no expuso ni persistió.
- **NO EJECUTADO**: contrato o request documentado, pero no enviado a ejecución.

## 01 — 01-create-script-request.json

Fuente: ../same-copy-three-mediums/fotografia/01-create-script-request.json
...
Fuente: ../same-copy-three-mediums/fotografia/02-business-context-snapshot.json
...
Fuente: ../same-copy-three-mediums/fotografia/03-commercial-branch-snapshot.json
...
Fuente: ../same-copy-three-mediums/fotografia/04-copy-kit-resolution.json
...
Fuente: ../same-copy-three-mediums/fotografia/05-branch-context-block.txt
...
Fuente: ../same-copy-three-mediums/fotografia/06-editorial-bans-block.txt
