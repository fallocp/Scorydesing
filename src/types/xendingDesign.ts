...
export interface CopyIdea {
  ...
  imageSuggestion?: string;
  /**
   * V2 multi-channel piece: { id, shared, overlays{professional,square,vertical}, captions{linkedin,facebook,instagram} }.
   * Populated when the idea was generated by `masterContentPrompt v2`. NULL for legacy v1 ideas.
   * Stored as opaque object here to avoid coupling this types file to React Query types.
   */
  pieceV2?: Record<string, unknown> | null;
}
